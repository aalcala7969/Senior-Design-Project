                ...
                BoxLayout:
                    ...
                    BoxLayout:
                        ...
                        StyledButton:
                            ...
                            on_press: root.choose_ttt_difficulty('easy')
                        StyledButton:
                            text: 'Hard\\nUnbeatable'
                            font_size: 40
                            size_hint_y: 1
                            ...
                            on_press: root.choose_ttt_difficulty('hard')
                        StyledButton:
            ...
            BoxLayout:
                ...
                BoxLayout:
                    ...
                    Image:
                        ...
                        keep_ratio: True
                    Label:
                        text: 'Guess the hidden word one letter at a time. Each wrong letter brings the robot one step closer to finishing the gallows. Win by solving the word before running out of turns.'
                        font_size: 38
                        size_hint_y: 0.5
                        text_size: (self.width - 20, self.height - 20)
                        halign: 'center'
    ...
    AnchorLayout:
        ...
        BoxLayout:
            ...
            StyledButton:
                ...
                on_press: root.start_ttt('player')
            StyledButton:
            ...
            StyledButton:
                ...
                on_press: root.back_to_ttt_menu()
""")
